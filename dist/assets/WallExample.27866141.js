var j=Object.defineProperty;var A=(t,s,o)=>s in t?j(t,s,{enumerable:!0,configurable:!0,writable:!0,value:o}):t[s]=o;var y=(t,s,o)=>(A(t,typeof s!="symbol"?s+"":s,o),o);import{k as W,a4 as E,aj as R,a9 as M,y as B,b as C,J as T,C as _,r as D,S as V,P as G,W as N,au as k,O as H,a as z,d as U,c as P,B as O,j as F,V as S,o as $}from"./index.efc1f02a.js";var I={exports:{}};(function(t,s){(function(o,e){t.exports=e()})(W,function(){var o=function(){function e(c){return a.appendChild(c.dom),c}function r(c){for(var u=0;u<a.children.length;u++)a.children[u].style.display=u===c?"block":"none";m=c}var m=0,a=document.createElement("div");a.style.cssText="position:fixed;top:0;left:0;cursor:pointer;opacity:0.9;z-index:10000",a.addEventListener("click",function(c){c.preventDefault(),r(++m%a.children.length)},!1);var i=(performance||Date).now(),f=i,n=0,v=e(new o.Panel("FPS","#0ff","#002")),w=e(new o.Panel("MS","#0f0","#020"));if(self.performance&&self.performance.memory)var p=e(new o.Panel("MB","#f08","#201"));return r(0),{REVISION:16,dom:a,addPanel:e,showPanel:r,begin:function(){i=(performance||Date).now()},end:function(){n++;var c=(performance||Date).now();if(w.update(c-i,200),c>f+1e3&&(v.update(1e3*n/(c-f),100),f=c,n=0,p)){var u=performance.memory;p.update(u.usedJSHeapSize/1048576,u.jsHeapSizeLimit/1048576)}return c},update:function(){i=this.end()},domElement:a,setMode:r}};return o.Panel=function(e,r,m){var a=1/0,i=0,f=Math.round,n=f(window.devicePixelRatio||1),v=80*n,w=48*n,p=3*n,c=2*n,u=3*n,d=15*n,x=74*n,g=30*n,h=document.createElement("canvas");h.width=v,h.height=w,h.style.cssText="width:80px;height:48px";var l=h.getContext("2d");return l.font="bold "+9*n+"px Helvetica,Arial,sans-serif",l.textBaseline="top",l.fillStyle=m,l.fillRect(0,0,v,w),l.fillStyle=r,l.fillText(e,p,c),l.fillRect(u,d,x,g),l.fillStyle=m,l.globalAlpha=.9,l.fillRect(u,d,x,g),{dom:h,update:function(b,L){a=Math.min(a,b),i=Math.max(i,b),l.fillStyle=m,l.globalAlpha=1,l.fillRect(0,0,v,d),l.fillStyle=r,l.fillText(f(b)+" "+e+" ("+f(a)+"-"+f(i)+")",p,c),l.drawImage(h,u+n,d,x-n,g,u,d,x-n,g),l.fillRect(u+x-n,d,n,g),l.fillStyle=m,l.globalAlpha=.9,l.fillRect(u+x-n,d,n,f((1-b/L)*g))}}},o})})(I);var q=I.exports;function J(t){return t===null}function K(t){return t===void 0}function Q(){const t=new q;return t.showPanel(0),document.body.appendChild(t.dom),t}function X(t){return!K(t)&&!J(t)&&Reflect.has(t,"getContext")}function Y(){const t=document.getElementById("canvas");if(X(t))return t.width=document.body.clientWidth,t.height=document.body.clientHeight,t;throw new Error("")}class Z extends E{constructor(s,o){super(),this.type="WallGeometry";const e=[],r=[];for(let m=0,a=e.length,i=r.length;m<s.length-1;m++){let f=1,n=s[m],v=s[m+1];e[a++]=n.x,e[a++]=0,e[a++]=n.y,r[i++]=0,r[i++]=0,e[a++]=v.x,e[a++]=0,e[a++]=v.y,r[i++]=1,r[i++]=0,e[a++]=n.x,e[a++]=o,e[a++]=n.y,r[i++]=0,r[i++]=f,e[a++]=n.x,e[a++]=o,e[a++]=n.y,r[i++]=0,r[i++]=f,e[a++]=v.x,e[a++]=0,e[a++]=v.y,r[i++]=1,r[i++]=0,e[a++]=v.x,e[a++]=o,e[a++]=v.y,r[i++]=1,r[i++]=f}this.setAttribute("position",new R(new Float32Array(e),3)),this.setAttribute("uv",new R(new Float32Array(r),2))}}var ee=`
...
`;class oe extends M{constructor(o){super(o);y(this,"animation",o=>{this.uniforms.time.value+=o});const e=new B().load("images/test1.jpg");this.vertexShader=ee,this.fragmentShader=te,this.uniforms={time:{value:0},speed:{value:.25},textureMap:{value:e}},this.side=C,this.transparent=!0,this.depthWrite=!1}}var ae=`
